...
const Introduction = () => {
  return (
    <div className="mt-10 mx-80">
      ...
      <Description
        description={`A Software Craftsperson at Incubyte is a person who has a strong
      ...
      <br />
      <Description
        description={`TDD is a core practice for all of us at Incubyte. We strongly believe
        that well written software, is a lot more valuable for the business and
        end users, as compared to software that is hacked together (but works!).`}
      />
      <br />
      <Description
        description={`Through this assessment, we want to evaluate how readable and testable
        your code is. We want to see the Software Craftsperson in you.`}
      />
      <br />
      <Description
        description={`As software developers, searching the internet is something of a
        necessity and is vital tool for being effective problem solvers. We
        encourage you to Google away! You can also visit our inspiration page to
        find some useful talks and references that will help you sail through
        this assessment.`}
      />
      <br />
      <Description
        description={`With that, let’s jump right in! Follow the instructions below, take your
        time to do it well and send us your kata once you’re happy with what
        you’ve done. Make sure you follow TDD throughout this assessment!`}
      />
      <ProblemStatement />
